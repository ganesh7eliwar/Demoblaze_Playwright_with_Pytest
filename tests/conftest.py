...
def pytest_addoption(parser):
    ...
    parser.addoption("--base-url", default="https://demoblaze.com/index.html", help="Base URL for tests")
...
def browser_context(request):
    ...
    print(f"\n[OK] Starting browser: {browser_name}")
...
def page(request, browser_context):
    ...
    print(f"\n[RESULT] Test '{test_name}' result: {'[FAIL]' if test_failed else '[PASS]'}")
